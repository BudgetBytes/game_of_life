...
int main(int argc, char **argv)
{
    ...
    bool world[ROWS][COLUMNS] = {false};
    if (strcmp(command, "block") == 0) show_world(init_world_as_block, world);
    else if (strcmp(command, "glider") == 0) show_world(init_world_as_glider, world);
    else if (strcmp(command, "blinker") == 0) show_world(init_world_as_blinker, world);
    else if (strcmp(command, "pulsar") == 0) show_world(init_world_as_pulsar, world);
    else if (strcmp(command, "gun") == 0) show_world(init_world_as_glider_gun, world);
    else if (strcmp(command, "random") == 0) show_world(init_world_randomly, world);
    else if (strcmp(command, "create") == 0) create_world();
    else
    {
